        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status == 'success') {
              ...
              window.setTimeout(function () {
                location.assign('/'); //location.reload(); // refresh
              }, 1500);
            }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW51cmFnLWMiLCJhIjoiY2twam5jZXA2MGFwMzJ1b2FneTAxZ2I3cSJ9.VNt-xXJ-a23aT9bt3lPJ7w';
...
var stripe = Stripe('pk_test_51J1225SJXSNEDbiRVQwFAxjaVWuYen0tSiOTKUU5EKEXIlFgmo2jaCU6m54sFgvcPjI21DZrzlA7zSopuHLJdxKl00BJ0u4wDo');
